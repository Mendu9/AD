...
class RAGNodes:
    ...
    def _build_tools(self) -> List[Tool]:
        ...
        return [retriever_tool, wikipedia_tool,tavily_tool]
    ...
    def _build_agent(self):
        ...
        system_prompt = (
            ...
            "Prefer 'retriever' for user-provided docs; use 'wikipedia' for general knowledge; use 'tavily' for web based search. "
